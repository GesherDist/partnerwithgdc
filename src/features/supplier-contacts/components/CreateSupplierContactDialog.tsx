...
/**
 * Create Supplier Contact Dialog Component
 *
 * Dialog for creating a new supplier contact.
 */
...
import { createSupplierContactAction } from '../actions';
...
interface CreateSupplierContactDialogProps {
  supplierId: string;
  open: boolean;
  onClose: () => void;
...
export function CreateSupplierContactDialog({
  ...
  const handleSubmit = async (values: CreateContactFormValues) => {
    ...
    try {
      const result = await createSupplierContactAction({
        supplierId,
      ...
      if (result.success && result.data) {
        toast.success(`${result.data.firstName} ${result.data.lastName} has been added successfully.`);
        form.reset();
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new contact for this supplier. Fill in the contact details below.
          </DialogDescription>
        </DialogHeader>
